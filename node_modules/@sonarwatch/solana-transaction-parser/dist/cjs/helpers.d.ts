...
import { AccountMeta, CompiledInstruction, Message, PartiallyDecodedInstruction, Transaction, TransactionInstruction, TransactionResponse } from "@solana/web3.js";
 ...
 */
export declare function parseTransactionAccounts(message: Message): AccountMeta[];
/**
 ...
 */
export declare function compiledInstructionToInstruction(compiledInstruction: CompiledInstruction, parsedAccounts: AccountMeta[]): TransactionInstruction;
 ...
 */
export declare function flattenTransactionResponse(transaction: TransactionResponse): Transaction;
/**
